...
export default function PergoladoDeConcretoPage() {
  return (
    <>
      {/* 01 HERO */}
      <section
        className="bg-white border-b border-cc-gray-200 py-12 sm:py-16"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav aria-label="breadcrumb" className="mb-6 text-sm text-cc-gray-600">
            <ol className="flex flex-wrap gap-2">
              <li>
                <a href="/" className="hover:text-cc-green">
                  Início
                </a>
              </li>
              <li aria-hidden="true">›</li>
              <li>
                <a href="/produtos" className="hover:text-cc-green">
                  Produtos
                </a>
              </li>
              <li aria-hidden="true">›</li>
              <li className="text-cc-green font-semibold">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <h1
                id="pergolado-title"
                className="text-3xl sm:text-4xl lg:text-5xl font-bold text-cc-green mb-4 leading-tight"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-cc-whatsapp hover:bg-cc-whatsapp-hover text-white px-7 py-3.5 rounded-full text-base font-bold transition-colors"
              >
