...
export default function PergoladoDeConcretoPage() {
  return (
    <>
      ...
      <section
        className="py-16 md:py-24 bg-cc-gray-50"
      ...
      >
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mb-16">
            <p className="text-xs font-medium tracking-widest text-cc-orange mb-3">
              COBERTURA EXCLUSIVA
            </p>
            <h2
              id="cobertura-title"
            ...
            <p className="text-base md:text-lg text-cc-gray-600 leading-relaxed max-w-3xl mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {cidades.map((cidade) => (
                <span
                  key={cidade}
                  className="px-4 py-1.5 bg-white border border-cc-gray-200 rounded-full text-sm text-cc-gray-700"
                >
                  {cidade}
                </span>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-16">
            ...
            <div className="bg-white rounded-xl p-6 md:p-8 border border-cc-gray-200 flex flex-col justify-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-10">
              {cidades.map((cidade) => (
                <div
                  key={cidade}
                  className="bg-white border border-cc-gray-200 rounded-lg py-4 px-3 text-center hover:border-cc-gray-300 transition-colors"
                >
            ...
            <div className="text-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-cc-orange text-white rounded-lg font-medium hover:bg-cc-orange-dark transition-colors"
              >
