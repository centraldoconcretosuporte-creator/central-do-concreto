    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-16 md:py-24 text-center">
          ...
          <div className="flex justify-center mb-8">
            <WhatsAppLink
              href={WHATSAPP_URL}
              source="pergolado-de-concreto-hero"
              target="_blank"
        ...
        <div className="mx-auto max-w-6xl px-4">
              ...
              <div className="flex flex-wrap gap-2">
                {cidades.map((c) => (
                  <WhatsAppLink
                    key={c.nome}
                    href={c.href}
                    source={`pergolado-de-concreto-cidade-chip-${c.nome}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-16">
            ...
            <div className="bg-cc-gray-100 rounded-xl p-6 md:p-8 border border-cc-gray-200 flex flex-col justify-center">
              ...
              <WhatsAppLink
                ...
                source="pergolado-de-concreto-cta"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-10">
              {cidades.map((c) => (
                <WhatsAppLink
                  key={c.nome}
                  href={c.href}
                  source={`pergolado-de-concreto-cidade-grid-${c.nome}`}
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="text-center">
              <WhatsAppLink
                href={WHATSAPP_COBERTURA_URL}
                source="pergolado-de-concreto-cta-2"
                target="_blank"
                rel="noopener noreferrer"
      ...
      <section className="bg-cc-orange py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <WhatsAppLink
            href={WHATSAPP_URL}
            source="pergolado-de-concreto-final"
            target="_blank"
            rel="noopener noreferrer"
