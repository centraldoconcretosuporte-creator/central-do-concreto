...
export const metadata = {
  title: "Pergolado de Concreto — Central do Concreto · Ivoti-RS",
  description:
    "Pergolado de concreto pré-moldado amadeirado em Ivoti-RS. Estrutura sem cupim, sem manutenção, durabilidade de 30+ anos. Entrega e instalação na Serra Gaúcha.",
};

export default function PergoladoPage() {
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div className="bg-cc-gray-50 border border-cc-gray-200 rounded-lg p-6 sm:p-10 text-center">
        <p className="text-base sm:text-lg text-cc-gray-600 mb-8 leading-relaxed">
          Página em construção. Em breve, galeria com fotos reais de obras prontas, ficha técnica (dimensões dos pilares e vigas, acabamentos disponíveis), pacote completo (com Telhas Ivoti e ganchos para rede), e exemplos de aplicações em jardins e áreas de lazer.
        </p>
