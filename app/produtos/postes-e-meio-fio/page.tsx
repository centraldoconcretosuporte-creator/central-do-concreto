...
export const metadata = {
  title: "Postes e Meio-fio — Central do Concreto · Ivoti-RS",
  description:
    "Postes de concreto para iluminação e meio-fio para pavimentação em Ivoti-RS. Estruturas padronizadas com máxima durabilidade.",
};

export default function PostesMeioFioPage() {
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div className="bg-cc-gray-50 border border-cc-gray-200 rounded-lg p-6 sm:p-10 text-center">
        <p className="text-base sm:text-lg text-cc-gray-600 mb-8 leading-relaxed">
          Página em construção. Em breve, ficha técnica de postes (alturas, classes), tipos de meio-fio (chapéu, simples), aplicações em iluminação pública e pavimentação urbana, e padrões dimensionais.
        </p>
