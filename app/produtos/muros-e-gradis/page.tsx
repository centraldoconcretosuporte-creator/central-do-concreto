...
export const metadata = {
  title: "Muros e Gradis — Central do Concreto · Ivoti-RS",
  description:
    "Muros placa veneziana e gradis de concreto em Ivoti-RS. Fechamento residencial e comercial com qualidade controlada e entrega na Serra Gaúcha.",
};

export default function MurosGradisPage() {
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div className="bg-cc-gray-50 border border-cc-gray-200 rounded-lg p-6 sm:p-10 text-center">
        <p className="text-base sm:text-lg text-cc-gray-600 mb-8 leading-relaxed">
          Página em construção. Em breve, catálogo de modelos (placa veneziana, gradil), dimensões, aplicações em fechamento de terrenos e áreas comerciais, e exemplos de obras realizadas.
        </p>
