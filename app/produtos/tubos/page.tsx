...
export const metadata = {
  title: "Tubos de Concreto — Central do Concreto · Ivoti-RS",
  description:
    "Tubos de concreto PA1, PA2, parede fina, parede grossa, ponta-bolsa e macho-fêmea. Direto da fábrica em Ivoti-RS, com entrega na Serra Gaúcha.",
};
    ...
    <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div className="bg-cc-gray-50 border border-cc-gray-200 rounded-lg p-6 sm:p-10 text-center">
        <p className="text-base sm:text-lg text-cc-gray-600 mb-8 leading-relaxed">
          Página em construção. Em breve, ficha técnica completa com dimensões, tipos (PA1, PA2, parede fina/grossa), aplicações em drenagem urbana e saneamento, e normas ABNT de referência.
        </p>
