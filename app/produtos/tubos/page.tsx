...
export const metadata: Metadata = {
  title: "Tubos de Concreto · Central do Concreto",
  description:
    "Tubos de drenagem, esgoto e água pluvial. Pra construtoras, prefeituras e obras residenciais.",
  alternates: { canonical: `${SITE_URL}/produtos/tubos` },
};
      ...
      <section className="bg-cc-green py-20 md:py-28 text-center">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="text-base md:text-lg text-white/90 leading-relaxed max-w-xl mx-auto">
            Tubos de drenagem, esgoto e água pluvial. Pra construtoras, prefeituras e obras
            residenciais.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="text-base text-cc-gray-600 leading-relaxed mb-8">
            Estamos preparando a ficha técnica completa de tubos de concreto. Enquanto isso · pra
