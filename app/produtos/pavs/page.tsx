...
export const metadata: Metadata = {
  title: "PAVS · Central do Concreto",
  description: "Pavimento sextavado, holandês e estrela em concreto pré-moldado.",
  alternates: { canonical: `${SITE_URL}/produtos/pavs` },
};
      ...
      <section className="bg-cc-green py-20 md:py-28 text-center">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="text-base md:text-lg text-white/90 leading-relaxed max-w-xl mx-auto">
            Pavimento sextavado, holandês e estrela em concreto pré-moldado.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="text-base text-cc-gray-600 leading-relaxed mb-8">
            Estamos preparando a ficha técnica completa de PAVS. Enquanto isso · pra orçamento ou
            dúvida · fala direto pelo WhatsApp.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
