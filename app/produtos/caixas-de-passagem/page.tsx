...
export const metadata = {
  title: "Caixas de Passagem — Central do Concreto · Ivoti-RS",
  description:
    "Caixas de passagem em concreto para drenagem urbana e inspeção. Direto da fábrica em Ivoti-RS, com normas técnicas ABNT.",
};

export default function CaixasPassagemPage() {
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div className="bg-cc-gray-50 border border-cc-gray-200 rounded-lg p-6 sm:p-10 text-center">
        <p className="text-base sm:text-lg text-cc-gray-600 mb-8 leading-relaxed">
          Página em construção. Em breve, ficha técnica completa com dimensões padronizadas, aplicações (drenagem pluvial, esgoto, inspeção) e especificações dimensionais conforme ABNT.
        </p>
