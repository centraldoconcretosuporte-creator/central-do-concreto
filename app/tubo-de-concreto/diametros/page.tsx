...
const faqs = [
  ...
  },
  {
    ...
    a: "A Central entrega em Ivoti e região, num raio de cerca de 120 km. Cidades atendidas: Novo Hamburgo, Estância Velha, Dois Irmãos, Lindolfo Collor, Presidente Lucena, Bom Princípio, São José do Hortêncio, Campo Bom, Sapiranga, Morro Reuter, Picada Café, Santa Maria do Herval, Nova Petrópolis, Gramado e Canela. Frete sob orçamento conforme distância e volume.",
  },
];
        ...
        <div className="mx-auto max-w-3xl px-4 space-y-14">
          ...
          >
            ...
            <ol className="space-y-2 text-cc-gray-700">
              <li>
                <a href="#diametros-disponiveis" className="hover:text-cc-orange">
                  Quais são os diâmetros disponíveis de tubo de concreto? →
                </a>
              </li>
              <li>
                <a href="#notacao-dn" className="hover:text-cc-orange">
                  DN, milímetro ou centímetro — entendendo a notação →
                </a>
              </li>
              <li>
                <a href="#tabela-nbr-8890" className="hover:text-cc-orange">
              ...
              <li>
                <a href="#comprimento-util" className="hover:text-cc-orange">
                  Comprimento útil de cada diâmetro →
                </a>
              </li>
              <li>
                <a href="#diametros-central" className="hover:text-cc-orange">
          ...
          <section aria-labelledby="diametros-disponiveis">
            ...
            {/* CTA S4 — ski ramp: fecha a seção de diâmetros disponíveis */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Precisa de um diâmetro específico? Confirme a pronta entrega direto com a Central.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="diametros-cta"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <section aria-labelledby="como-escolher">
            ...
            {/* CTA S4 — ski ramp: fecha a seção como escolher o diâmetro */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Não sabe qual diâmetro pedir? Mande os dados da obra que a Central dimensiona.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="diametros-cta-2"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-cc-whatsapp hover:bg-cc-whatsapp-hover text-white px-7 py-3.5 rounded-full font-medium text-base md:text-lg transition-colors shadow-lg"
              >
          ...
          <section aria-labelledby="diametros-central">
            ...
            <div className="space-y-4 text-base text-cc-gray-700 leading-relaxed">
              ...
              <p>
                ...
                num raio de cerca de 120 km — Novo Hamburgo, Estância Velha, Dois
            ...
            {/* CTA S4 — ski ramp: fecha a seção diâmetros disponíveis na Central */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Já definiu o diâmetro? Peça o orçamento com o frete calculado pelo endereço.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="diametros-cta-3"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-cc-whatsapp hover:bg-cc-whatsapp-hover text-white px-7 py-3.5 rounded-full font-medium text-base md:text-lg transition-colors shadow-lg"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 max-w-3xl mx-auto mb-10">
            {cidades.map((cidade) => (
              <WhatsAppLink
                ...
                source={`diametros-cidade-${cidade.toLowerCase().replace(/\s+/g, "-")}`}
                target="_blank"
                rel="noopener noreferrer"
