    ...
    <>
        ...
        <div className="mx-auto max-w-3xl px-4 space-y-14">
          ...
          >
            ...
            <ol className="space-y-2 text-cc-gray-700">
              <li>
                <a href="#o-que-e-tubo-dreno" className="hover:text-cc-orange">
                  O que é o tubo dreno de concreto? →
                </a>
              </li>
              <li>
                <a href="#para-que-serve" className="hover:text-cc-orange">
                  Para que serve um tubo dreno? →
                </a>
              </li>
              <li>
                <a href="#relevo-serra-gaucha" className="hover:text-cc-orange">
                  Por que o relevo da Serra Gaúcha muda o projeto de drenagem →
                </a>
              </li>
              <li>
                <a href="#onde-se-usa" className="hover:text-cc-orange">
                  Onde se usa o tubo dreno de concreto? →
                </a>
              </li>
              <li>
                <a href="#concreto-vs-pead" className="hover:text-cc-orange">
                  Tubo dreno de concreto e tubo dreno de PEAD — quando escolher cada um? →
                </a>
              </li>
              <li>
                <a href="#como-se-instala" className="hover:text-cc-orange">
                  Como se instala um tubo dreno? →
                </a>
              </li>
              <li>
                <a href="#diametros-tubo-dreno" className="hover:text-cc-orange">
                  Diâmetros do tubo dreno de concreto →
                </a>
              </li>
              <li>
                <a href="#tubo-dreno-central" className="hover:text-cc-orange">
          ...
          <section aria-labelledby="para-que-serve">
            ...
            {/* CTA S3 — ski ramp: fecha a seção para que serve */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Vai drenar muro de arrimo ou talude? Fale com a Central e acerte o diâmetro.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="tubo-dreno-cta"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <section aria-labelledby="concreto-vs-pead">
            ...
            {/* CTA S3 — ski ramp: fecha a seção concreto vs PEAD */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Na dúvida entre concreto e PEAD? Mande as medidas que a Central indica o certo.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="tubo-dreno-cta-2"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-cc-whatsapp hover:bg-cc-whatsapp-hover text-white px-7 py-3.5 rounded-full font-medium text-base md:text-lg transition-colors shadow-lg"
              >
          ...
          <section aria-labelledby="diametros-tubo-dreno">
            ...
            {/* CTA S3 — ski ramp: fecha a seção de diâmetros */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Já sabe o diâmetro? Peça o orçamento com o frete calculado pelo endereço.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="tubo-dreno-cta-3"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-cc-whatsapp hover:bg-cc-whatsapp-hover text-white px-7 py-3.5 rounded-full font-medium text-base md:text-lg transition-colors shadow-lg"
              >
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 max-w-3xl mx-auto mb-10">
            {cidades.map((cidade) => (
              <WhatsAppLink
                key={cidade}
                source={`tubo-dreno-cidade-${cidade.toLowerCase().replace(/\s+/g, "-")}`}
      ...
      <section className="bg-cc-black py-14 md:py-16">
        <div className="mx-auto max-w-3xl px-4 text-center text-white">
          <h2 id="fale-direto-com-o-andre-no-whatsapp-atendimento-agilizado-se" className="text-2xl md:text-3xl font-bold mb-3">Fale direto com o André no WhatsApp · atendimento agilizado, sem intermediário</h2>
