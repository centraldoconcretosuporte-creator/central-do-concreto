        ...
        <div className="mx-auto max-w-3xl px-4 space-y-14">
          ...
          >
            ...
            <ol className="space-y-2 text-cc-gray-700">
              ...
              <li>
                <a href="#aplicacoes-propriedade" className="hover:text-cc-orange">
                  Aplicações em propriedade — entrada, bueiro de acesso, drenagem de muro →
                </a>
              </li>
              <li>
                <a href="#aplicacoes-loteamento" className="hover:text-cc-orange">
                  Aplicações em loteamento e via local — galeria de rua, ramal de esgoto →
                </a>
              </li>
              <li>
                <a href="#aplicacoes-urbana" className="hover:text-cc-orange">
                  Aplicações em infraestrutura urbana — galeria principal, travessia de córrego →
                </a>
              </li>
              <li>
                <a href="#esgoto-sanitario" className="hover:text-cc-orange">
                  Esgoto sanitário — quando o tubo é a peça obrigatória →
                </a>
              </li>
              <li>
                <a href="#fossa-septica" className="hover:text-cc-orange">
              ...
              <li>
                <a href="#aplicacoes-central" className="hover:text-cc-orange">
          ...
          <section aria-labelledby="aplicacoes-propriedade">
            ...
            {/* CTA S5 — ski ramp: fecha a seção aplicações em propriedade */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Tem obra residencial pela frente? Confirme bitola e quantidade direto com a Central.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="aplicacoes-cta"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <section aria-labelledby="como-escolher">
            ...
            {/* CTA S5 — ski ramp: fecha a seção como saber qual tubo pedir */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Não sabe qual tubo pedir? Mande o tipo de obra que a Central indica a especificação.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="aplicacoes-cta-2"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-cc-whatsapp hover:bg-cc-whatsapp-hover text-white px-7 py-3.5 rounded-full font-medium text-base md:text-lg transition-colors shadow-lg"
              >
          ...
          <section aria-labelledby="aplicacoes-central">
            ...
            <div className="space-y-4 text-base text-cc-gray-700 leading-relaxed">
              ...
              <p>
                Atendemos Ivoti e cidades em raio de aproximadamente 120 km:
            ...
            {/* CTA S5 — ski ramp: fecha a seção aplicações atendidas pela Central */}
            <div className="mt-10 text-center">
              <p className="text-base md:text-lg text-cc-gray-700 mb-6 leading-relaxed">
                Já sabe o que precisa? Peça o orçamento com o frete calculado pelo endereço.
              </p>
              <WhatsAppLink
                href={WHATSAPP_CTA_URL}
                source="aplicacoes-cta-3"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-cc-whatsapp hover:bg-cc-whatsapp-hover text-white px-7 py-3.5 rounded-full font-medium text-base md:text-lg transition-colors shadow-lg"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 max-w-3xl mx-auto mb-10">
            {cidades.map((cidade) => (
              <WhatsAppLink
                ...
                source={`aplicacoes-cidade-${cidade.toLowerCase().replace(/\s+/g, "-")}`}
                target="_blank"
                rel="noopener noreferrer"
