  ...
  return (
    <header className="sticky top-0 z-40 bg-cc-black text-white border-b border-cc-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <WhatsAppLink
          href={WHATSAPP_URL}
          source="header-botao-desktop"
          target="_blank"
          rel="noopener noreferrer"
          className="hidden lg:inline-flex items-center gap-2 bg-cc-whatsapp hover:bg-cc-whatsapp-hover text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-colors"
